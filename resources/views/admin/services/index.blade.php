        ...
        <div class="content-wrapper" style="min-height: 257px">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Liste de services</h1>
                        </div><!-- /.col -->
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex justify-content-around">
                                                                    ...
                                                                    <a href="{{ url('admin/services/'.$service->id.'/edit') }}" onclick="return confirm('Voules-vous modifier ce service')">
