                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="unité" id="unité" class="form-control">
                                        ...
                                        <option value="metre" @if($service->unité == "metre") selected @endif>Interne</option>
                                        <option value="place" @if($service->unité == "place") selected @endif>Place</option>
                                        <option value="panne" @if($service->unité == "panne") selected @endif>Panne</option>
                                        <option value="consulter" @if($service->unité == "consulter") selected @endif>Consulter</option>
                                    </select>
                                    @error('unité')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
